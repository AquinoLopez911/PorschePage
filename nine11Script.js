function get911Info() {
	...
	parent.id = "carreraBox";

	//var parent = document.getElementById("porscheXInfo");	//get parent

	//head block
	var heading = document.createElement("h1");				//heading for car
	heading.innerHTML = "Porsche 911";
	...
	xButton.addEventListener('click', exit911);
	...
	textFloat.id = "porsche911Info"; 						// created id because i need acces to change left margin, float, BG color and text color for the whole div
	textFloat.class = "porsche911Info";						// creadted class because i need to change elements inside the div
    ...
    document.getElementById("nine11B").disabled = true;

    document.getElementById("carreraBox").scrollIntoView(true);
}//end get911Info
...
function exit911() {
	...
	var parent = document.getElementById("carreraBox");	//get parent
	...
	document.getElementById("nine11B").innerHTML = "Porsche 911";
	
	document.getElementById("nine11B").disabled = false;
}