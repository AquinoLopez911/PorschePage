function getBoxterInfo() {
	...
	heading.id = "boxterh1";
	heading.innerHTML = "Porsche Boxter";
	...
	xButton.addEventListener('click', exitBoxter);
	...
	*/
	...
	textFloat.id = "porscheBoxterInfo"; 						// created id because i need acces to change left margin, float, BG color and text color for the whole div
	textFloat.class = "porscheBoxterInfo";						// creadted class because i need to change elements inside the div
    ...
    document.getElementById("boxterB").disabled = true;

    document.getElementById("boxterBox").scrollIntoView(true);
}//end get911Info
...
function exitBoxter() {
	...
	var parent = document.getElementById("boxterBox");	//get parent
	...
	document.getElementById("boxterB").innerHTML = "Porsche Boxter";

	document.getElementById("boxterB").disabled = false;
}